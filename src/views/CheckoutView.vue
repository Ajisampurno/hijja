    ...
    <div class="checkout-form w-full lg:w-1/2 bg-white shadow-md rounded-lg border border-grey p-4">
      ...
      <form @submit.prevent="confirmOrder" class="space-y-4">
        ...
        <div>
          ...
          <select id="province" v-model="province" @change="fetchCities" required
            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div>
          ...
          <select id="city" v-model="city" @change="fetchSubdistricts" required
            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div>
          ...
          <select id="subdistrict" v-model="subdistrict" @change="fetchShippingCost" required
            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            <option v-for="subdistrict in subdistricts" :key="subdistrict.subdistrict_id"
        ...
        <div>
          ...
          <select id="shipping" v-model="shippingMethod" required
            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            <option v-for="method in shippingMethods" :key="method.service" :value="method.cost[0].value">
